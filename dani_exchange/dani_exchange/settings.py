"""
Django settings for dani_exchange project.
...
SECRET_KEY = 'django-insecure-x+jlu+!y_mn7)^h^%$20os5p_byal3e8qnx$6ynjy9&4jx=v@+'
...
ROOT_URLCONF = 'dani_exchange.urls'
...
WSGI_APPLICATION = 'dani_exchange.wsgi.application'
...
LOG_ROOT = os.environ.get('LOG_ROOT', os.path.abspath(os.path.join(BASE_DIR, '..', 'log')))
LOGGING = {
    'version': 1,
...
CELERY_DEFAULT_QUEUE = 'dani_exchange'
CELERY_TASK_DEFAULT_QUEUE = 'dani_exchange'
